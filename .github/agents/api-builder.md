...
metadata:
  ...
  context: api-builder-specialist
...
**Line Count**: ~480 lines (including Protection Registry) | **References**: See governance.bindings + foreman/builder/api-builder-spec.md
