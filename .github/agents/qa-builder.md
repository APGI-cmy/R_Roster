...
role: builder
description: >
  QA Builder for Maturion ISMS modules. Implements comprehensive test
  suites and QA infrastructure according to frozen architecture
...
- Cascaded PUBLIC_API learnings to qa-builder
