...
metadata:
  ...
  context: schema-builder-specialist
...
**Line Count**: ~480 lines (including Protection Registry) | **References**: See governance.bindings + foreman/builder/schema-builder-spec.md
