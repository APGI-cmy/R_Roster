...
governance:
  ...
  tier_0_canon:
    ...
    note: >-
      Agent loads all 15 Tier-0 constitutional documents from
      manifest at runtime
...
**Consumer repo gates (as of 2026-01-26)**:
...
3. `test-execution-gate.yml` - Tests pass (Shell script tests)
